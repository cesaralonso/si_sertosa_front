...
export class FamilysService {
    ...
    constructor(
        ...
        this.endPoint = `${this._configuration.apiUrl}family`;
       }
       allFromTo = ( fechaDesde: string, fechaHasta: string ) : Observable<FamilysResponseInterface> => {
           return this._http.get<HttpResponse<any>>(`${this.endPoint}/from-to/${fechaDesde}/${fechaHasta}`, this.options)
               .pipe(
                   map((response: any) => response),
                   catchError(this.handleError));
       }
       all = () : Observable<FamilysResponseInterface> => {
           return this._http.get<HttpResponse<any>>(this.endPoint, this.options)
               .pipe(
                   map((response: any) => response),
                   catchError(this.handleError));
       }
       findById = ( id ) : Observable<FamilysResponseInterface> => {
           return this._http.get<HttpResponse<any>>(`${this.endPoint}/${id}`, this.options)
               .pipe(
                   map((response: any) => response),
                   catchError(this.handleError));
       }
       update = ( family: FamilysInterface ) : Observable<FamilysResponseInterface> => {
           return this._http.patch<HttpResponse<any>>(this.endPoint, family, this.options)
               .pipe(
                   map((response: any) => response),
                   catchError(this.handleError));
       }
       remove= ( id ) : Observable<FamilysResponseInterface> => {
           return this._http.delete<HttpResponse<any>>(`${this.endPoint}/${id}`, this.options)
               .pipe(
                   map((response: any) => response),
                   catchError(this.handleError));
       }
       exist = ( id ) : Observable<FamilysResponseInterface> => {
           return this._http.get<HttpResponse<any>>(`${this.endPoint}/${id}`, this.options)
               .pipe(
                   map((response: any) => response),
                   catchError(this.handleError));
       }
       count = () : Observable<FamilysResponseInterface> => {
           return this._http.get<HttpResponse<any>>(`${this.endPoint}`, this.options)
               .pipe(
                   map((response: any) => response),
                   catchError(this.handleError));
       }
       insert = ( family: FamilysInterface ) : Observable<FamilysResponseInterface> => {
           return this._http.post<HttpResponse<any>>(this.endPoint, family, this.options)
               .pipe(
                   map((response: any) => response),
                   catchError(this.handleError));
       }
       ...
       insertFile = ( family: FamilysInterface, documento?: File ) : Observable<any> => {

...
export class Si_permisosService {
    ...
    constructor(
        ...
        this.endPoint = `${this._configuration.apiUrl}si_permiso`;
       }
       ...
       allFromTo = ( fechaDesde: string, fechaHasta: string ) : Observable<Si_permisosResponseInterface> => {
       ...
       update = ( si_permiso: Si_permisosInterface ) : Observable<Si_permisosResponseInterface> => {
           return this._http.patch<HttpResponse<any>>(this.endPoint, si_permiso, this.options)
               .pipe(
                   map((response: any) => response),
                   catchError(this.handleError));
       }
       ...
       insert = ( si_permiso: Si_permisosInterface ) : Observable<Si_permisosResponseInterface> => {
           return this._http.post<HttpResponse<any>>(this.endPoint, si_permiso, this.options)
               .pipe(
                   map((response: any) => response),
                   catchError(this.handleError));
       }
       ...
       insertFile = ( si_permiso: Si_permisosInterface, documento?: File ) : Observable<any> => {
           var formData: any = new FormData();
           if (documento) {
               formData.append("documento", documento);
           }
           formData.append("codigo", si_permiso.codigo);
           formData.append("nombre", si_permiso.nombre);
           formData.append("si_rol_idsi_rol", si_permiso.si_rol_idsi_rol);
           formData.append("si_modulo_idsi_modulo", si_permiso.si_modulo_idsi_modulo);
           formData.append("acceso", si_permiso.acceso);
           formData.append("readable", si_permiso.readable);
           formData.append("writeable", si_permiso.writeable);
           formData.append("updateable", si_permiso.updateable);
           formData.append("deleteable", si_permiso.deleteable);
           formData.append("read_own", si_permiso.read_own);
           formData.append("write_own", si_permiso.write_own);
           formData.append("update_own", si_permiso.update_own);
           formData.append("delete_own", si_permiso.delete_own);

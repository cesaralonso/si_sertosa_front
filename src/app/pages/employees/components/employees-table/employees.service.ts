...
export class EmployeesService {
    ...
    constructor(
        ...
        this.endPoint = `${this._configuration.apiUrl}employee`;
       }
       findByIdCompanyunits = ( id ) : Observable<EmployeesResponseInterface> => {
           return this._http.get<HttpResponse<any>>(`${this.endPoint}/companyunits/${id}`, this.options)
               .pipe(
                   map((response: any) => response),
                   catchError(this.handleError));
       }
       findByIdSi_user = ( id ) : Observable<EmployeesResponseInterface> => {
           return this._http.get<HttpResponse<any>>(`${this.endPoint}/si_user/${id}`, this.options)
               .pipe(
                   map((response: any) => response),
                   catchError(this.handleError));
       }
       allFromTo = ( fechaDesde: string, fechaHasta: string ) : Observable<EmployeesResponseInterface> => {
           return this._http.get<HttpResponse<any>>(`${this.endPoint}/from-to/${fechaDesde}/${fechaHasta}`, this.options)
               .pipe(
                   map((response: any) => response),
                   catchError(this.handleError));
       }
       all = () : Observable<EmployeesResponseInterface> => {
           return this._http.get<HttpResponse<any>>(this.endPoint, this.options)
               .pipe(
                   map((response: any) => response),
                   catchError(this.handleError));
       }
       findById = ( id ) : Observable<EmployeesResponseInterface> => {
           return this._http.get<HttpResponse<any>>(`${this.endPoint}/${id}`, this.options)
               .pipe(
                   map((response: any) => response),
                   catchError(this.handleError));
       }
       update = ( employee: EmployeesInterface ) : Observable<EmployeesResponseInterface> => {
           return this._http.patch<HttpResponse<any>>(this.endPoint, employee, this.options)
               .pipe(
                   map((response: any) => response),
                   catchError(this.handleError));
       }
       remove= ( id ) : Observable<EmployeesResponseInterface> => {
           return this._http.delete<HttpResponse<any>>(`${this.endPoint}/${id}`, this.options)
               .pipe(
                   map((response: any) => response),
                   catchError(this.handleError));
       }
       exist = ( id ) : Observable<EmployeesResponseInterface> => {
           return this._http.get<HttpResponse<any>>(`${this.endPoint}/${id}`, this.options)
               .pipe(
                   map((response: any) => response),
                   catchError(this.handleError));
       }
       count = () : Observable<EmployeesResponseInterface> => {
           return this._http.get<HttpResponse<any>>(`${this.endPoint}`, this.options)
               .pipe(
                   map((response: any) => response),
                   catchError(this.handleError));
       }
       insert = ( employee: EmployeesInterface ) : Observable<EmployeesResponseInterface> => {
           return this._http.post<HttpResponse<any>>(this.endPoint, employee, this.options)
               .pipe(
                   map((response: any) => response),
                   catchError(this.handleError));
       }
       ...
       insertFile = ( employee: EmployeesInterface, documento?: File ) : Observable<any> => {

...
import { OrderinsAddModalComponent } from './orderins-add-modal/orderins-add-modal.component';
...
@Component({
selector: 'orderins-table',
templateUrl: './orderins-table.html',
styleUrls: ['./orderins-table.scss'],
})
export class OrderinsTableComponent implements OnInit {
    data;
    backpage: boolean;
